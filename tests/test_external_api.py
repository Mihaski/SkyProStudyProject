...
from src.external_api import convert_currency, API_KEY, BASE_URL
...
def test_convert_currency_different_currencies(mock_get, mock_api_key, from_currency, to_currency, amount,
                                               expected_result):
